...
SELECT                                                                              
  ...
  SUM(
    Y * 
    EXP(
      --CAST(CAST(proctime AS TIME) as NUMERIC) - 
      proctime - 
...
-- CAST(CAST(proctime AS TIMESTAMP) as NUMERIC): ! Cast function cannot convert value of type TIMESTAMP(3) to type DECIMAL(1073741823, 0)
-- CAST(CAST(proctime AS TIME) as NUMERIC):      ! Cast function cannot convert value of type TIME(0) to type DECIMAL(1073741823, 0)
/*
